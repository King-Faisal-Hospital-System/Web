      ...
      <div className="flex flex-col flex-1">
        ...
        <main className="flex-1 p-6 overflow-y-auto">
          ...
          <div className="bg-white p-6 mt-6 rounded-xl shadow-sm border border-gray-200">
            <h2 className="text-lg font-semibold mb-5">Account Registration Requests</h2>
            <table className="w-full text-left">
              ...
              <tbody>
                <tr className="border-t border-gray-100">
                  <td className="py-4 px-4">Dylan</td>
                  <td className="py-4 px-4">Jan 09, 2025</td>
                  <td className="py-4 px-4">
                    <span className="px-3 py-1 rounded-md text-white text-xs bg-green-600">
                      APPROVED
                    </span>
                  </td>
                  <td className="py-4 px-4">
                    <button className="px-4 py-2 bg-orange-500 text-white rounded-md hover:opacity-75">
                      Revoke Account
                    </button>
                  </td>
                </tr>
                <tr className="border-t border-gray-100">
                  ...
                  <td className="py-4 px-4">Jan 09, 2025</td>
                  <td className="py-4 px-4">
                    <span className="px-3 py-1 rounded-md text-white text-xs bg-orange-500">
                      PENDING
                    </span>
                  </td>
                  <td className="py-4 px-4">
                    <button className="px-4 py-2 bg-blue-500 text-white rounded-md hover:opacity-75">
                      Approve Account
                    </button>
                  </td>
                </tr>
